        ...
        <>
            ...
            <main className="min-h-screen bg-dark">
                ...
                <div className="container max-w-4xl text-center">
                    <h2 className="text-white text-3xl md:text-4xl font-bold mb-4">Ready to get started with creative media?</h2>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link href="/pricing" className="inline-flex items-center justify-center px-8 py-4 bg-cyan-600 hover:bg-cyan-500 shadow-[0_0_20px_rgba(6,182,212,0.3)] text-white font-bold rounded-lg transition-all">See Plans &amp; Pricing</Link>
