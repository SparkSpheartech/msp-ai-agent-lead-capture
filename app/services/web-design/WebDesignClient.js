    ...
    return (
        <>
            ...
            <main className="min-h-screen bg-dark">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            <div>
                                ...
                                <div className="flex flex-wrap gap-4">
                                    <Link href="#start-project" className="bg-primary hover:bg-primary/90 text-dark font-bold py-4 px-8 rounded-lg transition-all shadow-[0_0_20px_rgba(var(--primary-rgb),0.3)]">
                                        Start Your Project
                                    </Link>
                                    <Link href="#our-process" className="bg-transparent border border-white/20 hover:bg-white/5 text-white font-medium py-4 px-8 rounded-lg transition-all">
                                        How We Work
                                    </Link>
                                </div>
                            </div>
                            <div className="relative">
                                {/* Abstract UI Mockup */}
                                <div className="relative z-10 bg-dark-1 border border-white/10 rounded-2xl p-2 shadow-2xl transform rotate-3 hover:rotate-1 transition-all duration-500">
                ...
                <section className="py-24 border-t border-white/5 bg-dark-1/50">
                    <div className="container max-w-6xl">
                        <div className="text-center mb-16">
                            ...
                            <p className="text-gray-400">Comprehensive web solutions for every business need</p>
                        </div>
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                            {services.map((service, index) => (
                                <div key={index} className="group bg-dark border border-white/5 hover:border-primary/50 p-6 rounded-xl transition-all duration-300 hover:shadow-[0_0_30px_rgba(0,0,0,0.5)]">
                                    <div className="w-12 h-12 bg-white/5 rounded-lg flex items-center justify-center text-primary mb-4 group-hover:scale-110 transition-transform">
                    ...
                    <div className="container max-w-6xl">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                            ...
                            <div className="relative">
                                ...
                                <div className="relative bg-dark-1 border border-white/10 rounded-2xl p-8">
                                    <div className="space-y-6">
                                        ...
                                        <div className="flex items-center justify-between p-4 bg-white/5 rounded-lg border border-white/5">
                                            <span className="text-gray-300">SEO Rating</span>
                ...
                <section className="py-24 bg-dark-1 border-t border-white/5">
                    <div className="container max-w-6xl">
                        <div className="text-center mb-16">
                            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Recent Work</h2>
                            <p className="text-gray-400">See what we've built for our partners</p>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            {/* Project 1: Pakito's Taqueria */}
                            <Link href="https://pakitos-taqueria-demo.surge.sh/" target="_blank" className="group relative block bg-dark border border-white/10 rounded-xl overflow-hidden hover:border-primary/50 transition-all duration-300">
                                <div className="aspect-video bg-gray-800 relative overflow-hidden flex items-center justify-center group-hover:bg-gray-700 transition-colors">
                                    ...
                                    <div className="absolute inset-0 bg-primary/90 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                                        <span className="text-dark font-bold text-lg flex items-center gap-2">
                                            View Project <ArrowRight className="w-5 h-5" />
                                        </span>
                                    </div>
                                </div>
                                <div className="p-8">
                                    <h3 className="text-2xl font-bold text-white mb-2 group-hover:text-primary transition-colors">Pakito's Taqueria</h3>
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        <span className="px-3 py-1 bg-white/5 rounded-full text-xs text-gray-300 border border-white/10">React</span>
                                        <span className="px-3 py-1 bg-white/5 rounded-full text-xs text-gray-300 border border-white/10">Tailwind</span>
                                        <span className="px-3 py-1 bg-white/5 rounded-full text-xs text-gray-300 border border-white/10">Responsive</span>
                                    </div>
                                </div>
                            </Link>

                            {/* Project 2: MC Racing Sim */}
                            <Link href="https://mcracingsim-fw.surge.sh/" target="_blank" className="group relative block bg-dark border border-white/10 rounded-xl overflow-hidden hover:border-primary/50 transition-all duration-300">
                                <div className="aspect-video bg-gray-800 relative overflow-hidden flex items-center justify-center group-hover:bg-gray-700 transition-colors">
                                    <div className="text-center">
                                ...
                                <div className="p-8">
                                    <h3 className="text-2xl font-bold text-white mb-2 group-hover:text-emerald-500 transition-colors">MC Racing Sim</h3>
                                    <p className="text-gray-400 mb-4">
                                        Immersive landing page for a high-end racing simulator arcade, featuring booking integrations and dynamic visuals.
                                    </p>
                                    <div className="flex flex-wrap gap-2">
                                        <span className="px-3 py-1 bg-white/5 rounded-full text-xs text-gray-300 border border-white/10">Gaming</span>
                                        <span className="px-3 py-1 bg-white/5 rounded-full text-xs text-gray-300 border border-white/10">UI/UX</span>
                                        <span className="px-3 py-1 bg-white/5 rounded-full text-xs text-gray-300 border border-white/10">Animation</span>
                                    </div>
                                </div>
                            </Link>

                            {/* Project 3: Wildman Tatoopa */}
                            <Link href="https://wildmantatoopa.surge.sh/" target="_blank" className="group relative block bg-dark border border-white/10 rounded-xl overflow-hidden hover:border-primary/50 transition-all duration-300">
                                <div className="aspect-video bg-gray-800 relative overflow-hidden flex items-center justify-center group-hover:bg-gray-700 transition-colors">
                                    <div className="text-center">
                                ...
                                <div className="p-8">
                                    <h3 className="text-2xl font-bold text-white mb-2 group-hover:text-purple-500 transition-colors">Wildman Tatoopa</h3>
                                    <p className="text-gray-400 mb-4">
                                        A bold, artist-focused portfolio site designed to showcase creative work with unique style and attitude.
                                    </p>
                                    <div className="flex flex-wrap gap-2">
                                        <span className="px-3 py-1 bg-white/5 rounded-full text-xs text-gray-300 border border-white/10">Art/Portfolio</span>
                                        <span className="px-3 py-1 bg-white/5 rounded-full text-xs text-gray-300 border border-white/10">Branding</span>
                                        <span className="px-3 py-1 bg-white/5 rounded-full text-xs text-gray-300 border border-white/10">Gallery</span>
                                    </div>
                                </div>
                            </Link>
                        </div>
                ...
                <section id="start-project" className="py-24 border-t border-white/5 bg-dark-1 relative">
                ...
                <div className="container max-w-4xl text-center">
                    <h2 className="text-white text-3xl md:text-4xl font-bold mb-4">Ready to get started with web design?</h2>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link href="/pricing" className="inline-flex items-center justify-center px-8 py-4 bg-green-600 hover:bg-green-500 shadow-[0_0_20px_rgba(34,197,94,0.3)] text-white font-bold rounded-lg transition-all">See Plans &amp; Pricing</Link>
