        ...
        <div className="container max-w-6xl mx-auto px-6 pt-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {plans.map((plan, i) => (
              <div key={i} className={`border border-gray-800 bg-black/70 rounded-3xl p-8 flex flex-col ${plan.popular ? 'ring-2 ring-primary relative' : ''}`}>
                ...
                <a href="/contact" className="block mt-9 bg-primary hover:bg-lime-400 py-3 text-center text-black font-bold rounded-xl transition">
                  {plan.cta}
                </a>
              </div>
            ))}
          ...
          <div className="mt-16 bg-zinc-900/50 border border-primary/20 rounded-xl p-8 text-center">
            ...
            <p className="text-gray-400 mb-4">
              Most businesses save $2,400+ per month with our automation. 
              Use our ROI calculator to see your potential time/cost savings.
            </p>
