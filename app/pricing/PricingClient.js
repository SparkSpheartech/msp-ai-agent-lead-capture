    ...
    <>
      ...
      <main className="min-h-screen pt-20 pb-16 bg-dark text-white">
        <div className="container max-w-6xl mx-auto px-6 pt-8">
          ...
          {/* ROI Calculator */}
          <div className="bg-zinc-900/60 border border-primary/20 rounded-3xl p-8 md:p-10 mb-16 max-w-4xl mx-auto flex flex-col md:flex-row gap-10 shadow-[0_0_40px_rgba(163,230,53,0.08)] backdrop-blur-sm">
             <div className="flex-1 space-y-8">
                 ...
                 <div>
                     <div className="flex justify-between mb-3">
                         <label className="text-gray-300 font-medium">Hours Wasted <span className="text-gray-500 text-sm font-normal">(per employee/wk)</span></label>
                 ...
                 <div>
                     <div className="flex justify-between mb-3">
                         <label className="text-gray-300 font-medium">Avg. Hourly Wage</label>
             ...
             <div className="flex-1 bg-black/60 border border-gray-800/80 rounded-2xl p-8 flex flex-col justify-center items-center text-center relative overflow-hidden">
                 <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-primary to-transparent opacity-50"></div>
                 <div className="text-gray-400 font-medium mb-3">Estimated Monthly Savings</div>
                 ...
                 <div className="text-gray-400 font-medium mb-3">Recommended Plan</div>
                 <div className="text-3xl font-bold text-white mb-3">{recommendedPlan}</div>
                ...
                <div 
                    ...
                    className={`border rounded-3xl p-6 flex flex-col transition-all duration-500 ${
                        isRecommended 
                            ...
                            : 'border-gray-800 bg-black/70 opacity-70 hover:opacity-100'
                    }`}
                >
                  {isRecommended && (
                  ...
                  <div>
                    ...
                    <div className="text-gray-400 text-sm mb-1 font-medium">One-time setup</div>
                  ...
                  <ul className="mt-8 mb-8 text-sm space-y-3 flex-1">
                    {plan.features.map((f, idx) => (
                      <li key={idx} className="flex gap-3 items-start font-medium text-gray-200">
          ...
          <div className="mt-20 text-center text-gray-400 text-sm max-w-2xl mx-auto">
