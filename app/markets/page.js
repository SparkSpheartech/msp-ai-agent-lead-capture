...
export const metadata = {
  ...
  description: 'Explore industry-specific AI automation, market breakdowns, and field insights for HVAC, waste management, property management, and commercial service operations in Fort Wayne.',
  openGraph: {
    title: 'Markets We Service | SPARKSPHEAR Tech Solutions',
    description: 'Industry-specific Agentic systems, specialized AI agents, and market breakdowns for Fort Wayne businesses.',
