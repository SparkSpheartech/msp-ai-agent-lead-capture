...
import { ArrowLeft, Sparkles, ChevronRight, CheckCircle2 } from 'lucide-react';
...
export default function GuideClient({ slug, relatedPosts = [] }) {
 ...
 // If somehow not found (handled by server, but safety check)
 ...
 <span className="text-4xl">{vertical.emoji}</span>
 ...
 {vertical.tagline} We've researched and tested the top software solutions to help you save time, reduce costs, and scale your business.
 </p>
 </motion.div>
 </div>
 </header>
 ...
 <div className="bg-white dark:bg-zinc-900 shadow-sm dark:shadow-none border border-zinc-200 dark:border-white/10 rounded-3xl p-10 text-center relative overflow-hidden shadow-2xl">
 <Sparkles className="w-10 h-10 text-lime-600 dark:text-lime-400 mx-auto mb-4" />
 <h2 className="text-2xl md:text-3xl font-extrabold text-zinc-900 dark:text-white mb-4">
 Need a Custom AI Workflow?
 </h2>
 <p className="text-zinc-600 dark:text-gray-400 text-lg max-w-xl mx-auto mb-8">
 Off-the-shelf software is great, but sometimes you need a custom solution. We build custom AI agents and workflow automations tailored to your exact operations.
 </p>
