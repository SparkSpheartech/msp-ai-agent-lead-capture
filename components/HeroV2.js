...
const HeroV2 = () => {
 ...
 <Link href="/services/ai-automation" className="inline-flex items-center justify-center px-8 py-4 bg-primary text-zinc-900 dark:text-white font-bold hover:bg-primary/90 transition-all duration-300 min-w-[200px] rounded-md shadow-lg shadow-primary/20">
 ...
 <p className="text-zinc-600 dark:text-gray-400">Manual tasks eliminated</p>
 </div>
 <div className="stat-item text-center p-6 rounded-lg bg-white dark:bg-zinc-900/50 backdrop-blur-sm border border-primary/20">
