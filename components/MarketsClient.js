                    ...
                    <div className="mt-10 max-w-3xl mx-auto flex flex-col md:flex-row items-center gap-4">
                        <div className="relative w-full">
                            ...
                            <input 
                                ...
                                className="w-full pl-12 pr-4 py-3.5 bg-white/10 dark:bg-zinc-900/90 border border-white/20 dark:border-white/10 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:border-lime-500 transition-all backdrop-blur-md"
                            />
                        </div>
            ...
            <main className="max-w-7xl mx-auto px-6 py-16 w-full flex-grow">
                ...
                {loading ? (
                    ...
                    <div className="text-center py-20 bg-white dark:bg-zinc-900/50 rounded-3xl border border-gray-200 dark:border-white/10 p-12">
                        <Building2 className="w-16 h-16 text-lime-500 mx-auto mb-4 opacity-80" />
                            ...
                            >
                                <div>
                                    ...
                                    <div className="relative h-56 w-full overflow-hidden bg-zinc-950">
                                        ...
                                        <div className="absolute top-4 left-4 flex gap-2">
                                            {post.categories.slice(0, 2).map((cat, i) => (
                                                <span key={i} className="px-3 py-1 bg-black/80 backdrop-blur-md border border-lime-500/40 text-lime-400 text-xs font-bold rounded-full">
                                                    {cat}
                                                </span>
                                            ))}
                                        </div>
                                    ...
                                    <div className="p-6">
                                        ...
                                        <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3 group-hover:text-lime-600 dark:group-hover:text-lime-400 transition-colors line-clamp-2">
                ...
                <div className="mt-20 bg-gradient-to-r from-zinc-900 via-zinc-950 to-black border border-lime-500/30 rounded-3xl p-10 text-center relative overflow-hidden shadow-2xl">
                    ...
                    <p className="text-gray-300 text-lg max-w-xl mx-auto mb-8">
                        We build custom Agentic systems and specialized AI agents for any high-volume service business or enterprise operation in Fort Wayne.
                    </p>
