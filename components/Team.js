...
const Team = () => {
    return (
        <section className="section team animate-on-scroll bg-gray-50 dark:bg-zinc-950 text-gray-900 dark:text-white py-24">
            <div className="container">
                <div className="section-header text-center mb-16">
                    <span className="tag text-lime-600 dark:text-lime-400">OUR TEAM</span>
                    <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white">Dedicated experts ready to serve you</h2>
                </div>
                <div className="team-grid stagger-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 justify-center">
                    <div className="team-member group">
                        ...
                        <h4 className="text-xl font-bold text-gray-900 dark:text-white group-hover:text-lime-600 dark:group-hover:text-lime-400 transition-colors">Expert Leader</h4>
                        <p className="text-gray-500 dark:text-gray-500 uppercase text-sm tracking-wider">CEO, Tech Lead</p>
                    </div>
                    <div className="team-member group">
                        <div className="member-image relative overflow-hidden rounded-xl aspect-square mb-6 border border-gray-200 dark:border-white/10 group-hover:border-lime-500 dark:group-hover:border-lime-500/50 transition-colors">
                        ...
                        <h4 className="text-xl font-bold text-gray-900 dark:text-white group-hover:text-lime-600 dark:group-hover:text-lime-400 transition-colors">Executive Assistant</h4>
                        <p className="text-gray-500 dark:text-gray-500 uppercase text-sm tracking-wider">Operations</p>
                    </div>
                    <div className="team-member group">
                        <div className="member-image relative overflow-hidden rounded-xl aspect-square mb-6 border border-gray-200 dark:border-white/10 group-hover:border-lime-500 dark:group-hover:border-lime-500/50 transition-colors">
                        ...
                        <h4 className="text-xl font-bold text-gray-900 dark:text-white group-hover:text-lime-600 dark:group-hover:text-lime-400 transition-colors">CTO</h4>
                        <p className="text-gray-500 dark:text-gray-500 uppercase text-sm tracking-wider">Infrastructure</p>
                    </div>
                    <div className="team-member group">
                        <div className="member-image relative overflow-hidden rounded-xl aspect-square mb-6 border border-gray-200 dark:border-white/10 group-hover:border-lime-500 dark:group-hover:border-lime-500/50 transition-colors">
                        ...
                        <h4 className="text-xl font-bold text-gray-900 dark:text-white group-hover:text-lime-600 dark:group-hover:text-lime-400 transition-colors">Digital Specialist</h4>
                        <p className="text-gray-500 dark:text-gray-500 uppercase text-sm tracking-wider">Marketing</p>
                    </div>
                    <div className="team-member group">
                        <div className="member-image relative overflow-hidden rounded-xl aspect-square mb-6 border border-gray-200 dark:border-white/10 group-hover:border-lime-500 dark:group-hover:border-lime-500/50 transition-colors">
                        ...
                        <h4 className="text-xl font-bold text-gray-900 dark:text-white group-hover:text-lime-600 dark:group-hover:text-lime-400 transition-colors">DevOps Engineer</h4>
                        <p className="text-gray-500 dark:text-gray-500 uppercase text-sm tracking-wider">Hybrid Operations</p>
                    </div>
                </div>
