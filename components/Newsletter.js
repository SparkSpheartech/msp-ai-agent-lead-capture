            ...
            <div className="container max-w-4xl mx-auto text-center">
                <div className="mb-8">
                    <h2 className="text-gray-900 dark:text-white text-3xl md:text-4xl font-bold mb-4">
                        Stay <span className="text-lime-600 dark:text-lime-500">Connected</span>
                    </h2>
                ...
                <form onSubmit={handleSubmit} className="max-w-2xl mx-auto">
                    <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
                        <input
                            ...
                            required
                            className="flex-1 px-6 py-4 bg-gray-50 dark:bg-zinc-900 border-2 border-gray-300 dark:border-zinc-800 rounded-md text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:border-lime-500 focus:outline-none transition-colors w-full sm:w-auto"
                        />
                        <button
                            type="submit"
                    ...
                    {message && (
                        <p className={`mt-4 font-semibold ${status === 'success' ? 'text-lime-600 dark:text-lime-500' : 'text-red-500'}`}>
