...
const AIChat = () => {
 ...
 // Create a workflow with a webhook trigger that connects to an AI
 const AI_WEBHOOK_URL = 'YOUR_WEBHOOK_URL_HERE';
 ...
 let aiResponse = "I'm here to help! Please configure your webhook to enable AI responses.";
 ...
 // Full chat window
 return (
 <div className="fixed bottom-6 right-6 w-full max-w-md bg-white dark:bg-zinc-900 shadow-sm dark:shadow-none border border-zinc-800 rounded-2xl shadow-2xl z-50 overflow-hidden">
 {/* Header */}
 <div className="flex items-center justify-between p-4 bg-zinc-100 dark:bg-zinc-800/80 border-b border-zinc-700">
 <div className="flex items-center gap-3">
 <div className="w-10 h-10 bg-lime-500 rounded-full flex items-center justify-center">
 <Bot className="w-5 h-5 text-zinc-950" />
 </div>
 <div>
 <h3 className="text-zinc-900 dark:text-white font-bold">AI Assistant</h3>
 <p className="text-xs text-zinc-600 dark:text-gray-400">Powered by SparkSphear</p>
 </div>
 </div>
 <div className="flex items-center gap-2">
 <button
 onClick={() => setIsMinimized(true)}
 className="p-2 text-zinc-600 dark:text-gray-400 hover:text-zinc-900 dark:text-white transition-colors"
 >
 ...
 : 'bg-zinc-100 dark:bg-zinc-800/80 text-zinc-800 dark:text-gray-200'
 }`}
 >
 ...
 <div className="bg-zinc-100 dark:bg-zinc-800/80 p-3 rounded-lg">
 <Loader2 className="w-5 h-5 text-lime-600 dark:text-lime-500 animate-spin" />
 </div>
 </div>
 )}
 ...
 className="flex-1 px-4 py-3 bg-zinc-100 dark:bg-zinc-800/80 border border-zinc-700 rounded-lg text-zinc-900 dark:text-white placeholder-gray-500 focus:border-lime-500 focus:outline-none"
 disabled={isLoading}
 />
 <button
 onClick={handleSend}
